...
var misc = require('../lib/sftp-misc');
...
(function () {
    ...
    it.only = function () { return iti.only.apply(this, arguments); };
    it.skip = function () { return iti.skip.apply(this, arguments); };
    it.timeout = function () { return iti.timeout.apply(this, arguments); };
})();
...
describe("Basic Tests", function () {
    ...
    it("realpath(no-path)", function (done) {
        ...
        client.realpath(name, function (err) { return error(err, done, 'ENOENT', wrongPath); });
    });
    ...
    it("mkdir(no-path)", function (done) {
        var name = "dir000/subdir";
        client.mkdir(name, function (err) { return error(err, done, 'ENOENT', wrongPath); });
    });
    ...
    it("rmdir(no-path)", function (done) {
        var name = "dir000";
        client.rmdir(name, function (err) { return error(err, done, 'ENOENT', wrongPath); });
    });
    ...
    it("opendir(no-path)", function (done) {
        var name = "dir000";
        client.opendir(name, function (err, handle) { return error(err, done, 'ENOENT', wrongPath); });
    });
    ...
    it("rename(no-path, path2)", function (done) {
        ...
        client.rename(name1, name2, function (err) { return error(err, done, 'ENOENT', wrongPath); });
    });
    ...
    it("unlink(no-path)", function (done) {
        ...
        client.unlink(name, function (err) { return error(err, done, 'ENOENT', wrongPath); });
    });
    ...
    it("open(no-path, 'r+')", function (done) {
        ...
        client.open(name, "r+", function (err, handle) { return error(err, done, 'ENOENT', wrongPath); });
    });
            ...
            client.read(handle, buffer, 0, 30, 10, function (err) { return check(err, done, function () {
                client.read(handle, buffer, 30, 5, 66, function (err) { return check(err, done, function () {
                    client.read(handle, buffer, 10, 3, 40, function (err) { return check(err, done, function () {
                        ...
                        client.read(handle, buffer, 0, 10, 1000, function (err, bytesRead, buf) { return check(err, done, function () {
    ...
    it("stat(no-path)", function (done) {
        ...
        client.stat(name, function (err, attrs) { return error(err, done, 'ENOENT', wrongPath); });
    });
    ...
    it("lstat(no-path)", function (done) {
        var name = "dir000/file.txt";
        client.lstat(name, function (err, attrs) { return error(err, done, 'ENOENT', wrongPath); });
    });
    ...
    it("fstat(closed-handle)", function (done) {
        ...
        client.open(name, "r+", {}, function (err, handle) { return check(err, done, function () {
            client.close(handle, function (err) { return check(err, done, function () {
                client.fstat(handle, function (err, attrs) { return error(err, done, 'EFAILURE', "Invalid handle"); });
            }); });
        }); });
    });
    ...
    it("setstat(no-path)", function (done) {
        var name = "dir000/file.txt";
        client.setstat(name, { size: 12 }, function (err) { return error(err, done, 'ENOENT', wrongPath); });
    });
